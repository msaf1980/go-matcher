	...
	tests := []testGlob{
		...
		// merge strings to prefix
		{
			...
			want: &Glob{
				...
				Prefix: "aaZQ", Items: []items.Item{items.Star(0)},
			},
			verify: `^aaZQ.*$`,
		...
		// merge string to prefix and suffix
		{
			...
			want: &Glob{
				...
				Items: []items.Item{items.Star(0), items.NewString("INN"), items.Star(0)},
			},
		...
		},
		{
			...
			want: &Glob{
				...
				Items: []items.Item{items.Star(0), items.NewString("ЦNN"), items.Star(0)},
			},
		...
		},
		{
			...
			want: &Glob{
				...
				Items: []items.Item{
					items.Star(0), items.NewString("ИФ"), items.Star(0),
					items.NewString("bВ"), items.Star(0),
					items.NewString("ВNN"), items.Star(0),
					items.NewString("nnв"), items.Star(0),
					items.NewString("ВN"), items.Star(0),
				},
			},
		...
		},
		{
			...
			want: &Glob{
				...
				Items: []items.Item{items.Star(0), items.NewString("NNI"), items.Star(0)},
			},
